...
`# Pendente:` no rascunho, montar o rascunho do chamado já redigido, **perguntar**,
e só depois do seu "sim" abrir o chamado no GLPI pela tool `spec_feedback`
(fallback: issue `gap` neste repositório); retomar quando fechar.
